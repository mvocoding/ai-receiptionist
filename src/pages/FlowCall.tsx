...
export default function FlowCall(): JSX.Element {
  useEffect(() => {
    document.title = 'Fade Station · Call Flow Builder';
    const meta =
      document.querySelector('meta[name="description"]') ??
      document.createElement('meta');
    meta.setAttribute('name', 'description');
    meta.setAttribute('content', 'Build Call Conversation Flows');
  ...
  // load saved or demo
  useEffect(() => {
    const saved = localStorage.getItem('fadeStationFlow_call');
    if (saved) {
      try {
    ...
    const greeting = {
      ...
      width: 180,
      height: 120,
      text: 'Hi! My name is Angela. How can I help today?',
    };
    const condition = {
      id: 'node_3',
          ...
          <div className="px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-ios-textMuted">Call Flow Designer</p>
              </div>
            </div>
